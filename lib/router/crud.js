...
var createMiddlewareChain = function createMiddlewareChain(createMiddleware, Model, options) {
    var securitySchema = options.securitySchema,
        validationSchema = options.validationSchema;

    var crudMiddleware = createMiddleware(Model, options);
    var chain = [];
    if (securitySchema) chain.push((0, _middleware.permissions)(securitySchema));
                ...
                while (1) {
                    switch (_context4.prev = _context4.next) {
                        ...
                        case 3:
                            ...
                            return _context4.abrupt("return", instance ? res.json(instance) : next());
                ...
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        ...
                        case 3:
                            ...
                            return _context5.abrupt("return", instance ? res.status(204).send() : next());

...
var CrudRouter = function () {
  ...
  _createClass(CrudRouter, [{
    ...
    value: function createChain(middleware) {
      ...
      this.options.validationSchema && securityModifiers.some(function (modifier) {
        return modifier === "create" || modifier === "update";
      }) && chain.push((0, _middleware.validator)(this.options.validationSchema));

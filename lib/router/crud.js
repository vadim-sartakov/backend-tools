...
var createMiddlewareChain = function createMiddlewareChain(createMiddleware, Model, options, applyValidator) {
    var crudMiddleware = createMiddleware(Model, options);
    var securitySchema = options.securitySchema,
        validationSchema = options.validationSchema,
        logger = options.logger;

    var chain = [];
    if (securitySchema) chain.push((0, _middleware.security)(securitySchema, logger));
    if (applyValidator && validationSchema) chain.push((0, _middleware.validator)(validationSchema));
...
var createGetAll = function createGetAll(Model, options) {
    return (0, _http.asyncMiddleware)(function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(req, res) {
            var defaultPageSize, search, permissions, _req$query, page, size, filter, sort, result, totalCount, lastPage, prev, nextPage, link;

            return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            defaultPageSize = options.defaultPageSize, search = options.search;
                ...
                while (1) {
                    switch (_context6.prev = _context6.next) {
                        ...
                        case 3:
                            ...
                            return _context6.abrupt("return", instance ? res.status(204).end() : next());

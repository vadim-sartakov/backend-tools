...
var CrudModel = function () {
  function CrudModel(_ref) {
    var excerptProjection = _ref.excerptProjection,
        ...
        loadFields = _ref.loadFields,
        cascadeFields = _ref.cascadeFields;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (projection) projection = (0, _commonTools.createProjection)(projection);
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                if (projection) payload = (0, _commonTools.filterObject)(payload, projection);
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 6:
                ...
                payload = (0, _commonTools.filterObject)(payload, projection, initialObject);

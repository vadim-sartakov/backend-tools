  ...
  _createClass(SequelizeCrudModel, [{
    ...
    value: function searchFieldsToFilter(search, query) {
      return search.map(function (searchField) {
        return _defineProperty({}, '$' + searchField + '$', { $iLike: '%' + query + '%' });
      });
    }
  }, {
    key: 'execGetAll',
    ...
    key: 'convertProjection',
    value: function convertProjection(projection) {
      if (!projection || typeof projection !== 'string' || projection.length === 0) return;
      var paths = projection.split(' ');
      if (paths.length === 0) return;
      var exclusive = paths[0].startsWith('-');
      return exclusive ? { exclude: paths.map(function (curPath) {
          return curPath.substring(1);
        }) } : paths;
    }
  }, {
    key: 'convertSort',
    ...
    key: 'execCount',
    value: function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(filter) {
    ...
    key: 'execUpdateOne',
    value: function () {
      var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(filter, payload) {
        var _ref9, _ref10, affected, result;
    ...
    key: 'execDeleteOne',
    value: function () {
      var _ref11 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(filter) {

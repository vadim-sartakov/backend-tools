...
var SequelizeCrudModel = function (_CrudModel) {
  ...
  _createClass(SequelizeCrudModel, [{
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.next = 2;
                return this.Model.sequelize.transaction(function () {
                  var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(transaction) {
                      ...
                      while (1) {
                        switch (_context4.prev = _context4.next) {
                          case 0:
                            ...
                            if (_this3.cascadeFields) options.include = _this3.cascadeFields;
                            _context4.next = 4;
                            return _this3.Model.create(payload, options);

                          case 4:
                            instance = _context4.sent;
                            _context4.next = 7;
                            return Object.keys(_this3.Model.associations).reduce(function () {
                              var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(accumulator, association) {
                                var setter, value;
                                return regeneratorRuntime.wrap(function _callee3$(_context3) {
                                  while (1) {
                                    switch (_context3.prev = _context3.next) {
                                      case 0:
                                        if (!(_this3.cascadeFields && _this3.cascadeFields.some(function (cascadeField) {
                                          return cascadeField === association;
                                        }))) {
                                          _context3.next = 2;
                                          break;
                                        }
                                      ...
                                      case 2:
                                        setter = instance['set' + (association.charAt(0).toUpperCase() + association.substring(1))];
                                        ...
                                        _context3.next = 7;
                                        return setter.apply(instance, [value, { transaction: transaction }]);
    ...
    key: 'execUpdateOne',
    value: function () {
      var _ref11 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(filter, payload) {
        var _ref12, _ref13, affected, result;
      ...
      function execUpdateOne(_x9, _x10) {
    ...
    key: 'execDeleteOne',
    value: function () {
      var _ref14 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(filter) {

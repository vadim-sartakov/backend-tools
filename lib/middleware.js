...
var validator = exports.validator = function validator(constraints) {
    ...
    return function (req, res, next) {
        ...
        validators && Object.keys(validators).forEach(function (validator) {
            return _validate2.default.validators[validator] = validators[validator];
        });
...
var unauthorized = exports.unauthorized = function unauthorized(logger) {
    return function (req, res, next) {
